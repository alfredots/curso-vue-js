<template>
	<div id="app">
		...
		<component :is="componente">
			<span slot="vermelho">Conteúdo do Componente Vermelho</span>
			<span slot="azul">Conteúdo do Componente Azul</span>
			<span slot="verde">Conteúdo do Componente Verde</span>
		</component>
	</div>
</template>
